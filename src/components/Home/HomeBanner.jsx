...
const HomeBanner = () => {
    ...
    return (
        <div className="overflow-hidden">
            ...
            {/* ── Mobile Layout: text only, centered, full screen ── */}
            <div className="flex md:hidden flex-col items-center justify-center min-h-screen text-center px-6 pt-[100px] pb-16">
                ...
                >
                    <h1 className={`${poppins.className} text-[64px] leading-none font-bold text-white drop-shadow-4xl`}>
                        Admission
                    </h1>

                    <div className="flex flex-col items-center gap-1 mt-1">
                        <h2 className={`${poppins.className} text-[22px] text-[#FFF005] font-bold tracking-tight`}>
                            OPEN FOR
                        </h2>
                        <h2 className={`${poppins.className} text-[38px] font-bold text-[#FFF005]`}>
                            2026-2027
                        </h2>
                    </div>
                    ...
                    <motion.p
                        ...
                        className={`${poppins.className} text-[15px] text-white font-extralight mt-2 leading-8`}
                    >
                    ...
                    <motion.div
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="relative w-[190px] h-[58px] cursor-pointer group mt-4"
                    >
                        <Image
                            src="/button_cyan.png"
                        ...
                        <div className="absolute inset-0 flex items-center justify-center gap-2">
                            <span className={`${poppins.className} text-[18px] font-bold text-white`}>
                                Enroll Now
                            </span>
                            <ChevronsRight
                                size={24}
